 ...
 */
feedly.ajax = function () {
    "use strict";

    var _request = function(requestType, contentType, model, url, params, callback) {
        ...
        /// <param name="contentType">The type of data that you're expecting back from the server.</param>
    ...
    return {
         ...
         */
        get: function (contentType, model, url, params, callback) {

            return _request("GET", contentType, model, url, params, callback);
        },

        /*
         * For making post request
         */
        post: function (contentType, model, url, params, callback) {

            return _request("POST", contentType, model, url, params, callback);
        },

        /*
         * For making put request
         */
        put: function (contentType, model, url, params, callback) {

            return _request("PUT", contentType, model, url, params, callback);
        },

        /*
         * For making delete request
         */
        delete: function (contentType, model, url, params, callback) {

            return _request("DELETE", contentType, model, url, params, callback);
        }
    };
}();